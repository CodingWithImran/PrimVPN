package com.primvpm.secureproxy.supervpn.turbo.utils;
...
public class Preference {
    ...
    public void setStapperPreference(String key_value, boolean value) {
        this.prefsEditor.putBoolean(key_value, value).commit();
    }

    public boolean isStapperFirstTime(String key_value) {
        return appSharedPrefs.getBoolean(key_value, false);
    }
